...
_INSTALL_SCHEMES = {
    ...
    'vita_user': {
        'stdlib': 'ux0:/data/lib/python{py_version_short}',
        'platstdlib': 'ux0:/data/lib/python{py_version_short}',
        'purelib': 'ux0:/data/lib/python{py_version_short}/site-packages',
        'platlib': 'ux0:/data/lib/python{py_version_short}/site-packages',
        'include': 'ux0:/data/include/python{py_version_short}',
        'scripts': 'ux0:/data/bin',
        'data'   : 'ux0:/data',
        },
    'osx_framework_user': {
